...
async def cmd_start(message: Message):
    """Приветственное сообщение с дисклеймером"""
    await message.answer(
        "👋 <b>Добро пожаловать в бот бара «Пеликан Алаколь»!</b>
...
"
        ...
        "⚠️ <b>ВАЖНО:</b>
"
        "🌐 Заказы ТОЛЬКО через сайт: https://bar.pelikan-alakol.kz
"
        "💡 Бот НЕ принимает заказы напрямую!
"
        "❌ Без Telegram нет уведомлений!
...
"
        "2️⃣ Выберите блюда
"
        "3️⃣ Укажите Telegram: @{}
"
        "4️⃣ Получите уведомление
...
"
        "Приятного отдыха! 🏖️".format(
            message.from_user.username or "username"
        )
    )
@dp.message(Command("menu"))
async def cmd_menu(message: Message):
    """Меню бара с дисклеймером"""
    await message.answer(
        "🍽 <b>Меню бара «Пеликан Алаколь»</b>\n\n"
        "🌐 Заказ: https://bar.pelikan-alakol.kz\n\n"
        "🍔 FAST-FOOD — 900-4100₸\n"
        "🥗 САЛАТЫ — 1300-1500₸\n"
        "🍜 СУПЫ — 2100₸\n"
        "🍖 ГОРЯЧИЕ — 1000-3000₸\n"
        "👥 НА КОМПАНИЮ — 14000-17000₸\n\n"
        "💳 Оплата в баре | ⏰ 15-20 мин\n\n"
        "❗️ Укажите Telegram: @{}".format(
            message.from_user.username or "username"
        )
    )
