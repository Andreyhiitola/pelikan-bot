...
LOCATIONS = {
    ...
    "bus_station": {
        "name": "🚌 Автовокзал Ушарал",
        "lat": 46.181412,
        "lon": 80.952989,
        "address": "г. Ушарал",
        "description": "Автовокзал города Ушарал (85 км от курорта)",
        "phone": ""
    },
    "train_station": {
        "name": "🚂 ЖД вокзал Акши",
    ...
    "hospital": {
        ...
        "description": "Районная больница с круглосуточным приёмом (85 км от курорта)",
    ...
    "hotel_tolmart": {
        "name": "🏨 Гостиница Толмарт",
        "lat": 46.173308,
        "lon": 80.945331,
        "address": "г. Ушарал",
        "description": "Гостиница в городе Ушарал (85 км от курорта)",
        "phone": ""
    }
}
...
def get_navigation_keyboard():
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [
            InlineKeyboardButton(text="✈️ Аэропорт", callback_data="nav_airport"),
            InlineKeyboardButton(text="🚌 Автовокзал", callback_data="nav_bus_station")
        ],
        [InlineKeyboardButton(text="🚂 ЖД вокзал Акши", callback_data="nav_train_station")],
        [
            InlineKeyboardButton(text="🏥 Больница", callback_data="nav_hospital"),
            InlineKeyboardButton(text="💊 Медпункт", callback_data="nav_pharmacy")
        ],
        [InlineKeyboardButton(text="🏨 Гостиница Толмарт", callback_data="nav_hotel_tolmart")],
...
<b>Транспорт (Ушарал ~85 км):</b>
✈️ Аэропорт | 🚌 Автовокзал

<b>Рядом с курортом:</b>
🚂 ЖД вокзал Акши - 2 км от курорта

<b>Важные точки:</b>
🏥 Больница Ушарал - круглосуточная помощь
💊 Медпункт Акши - аптека рядом с курортом
🏨 Гостиница Толмарт - размещение в Ушарале
...
📱 +7 (701) 771 47 33
📱 +7 (705) 806 78 33
💬 WhatsApp: +7 (701) 771 47 33 / +7 (705) 806 78 33
📧 pelikan-08@mail.ru
...
<b>🚌 С автовокзала Ушарал:</b>
• Расстояние: 85 км (~1.5 часа)
• Маршрутки до Акши
• Такси или трансфер до курорта

<b>🚂 От ЖД вокзала Акши:</b>
...
• Медпункт в Акши: 1.5 км (лекарства, базовая помощь)
• Больница в Ушарале: 85 км (полный спектр услуг)
• Скорая помощь: 103

<b>🏨 Размещение в Ушарале:</b>
Если вам нужно переночевать в городе - гостиница Толмарт
...
📱 <b>WhatsApp:</b> +7 (776) 727 58 41
✈️ <b>Telegram:</b> https://t.me/+77767275841
...
✓ Откуда (аэропорт/автовокзал/вокзал/адрес)
